function getShippingCost(country) {
  ...
  switch (country) {
    ...
    case "Australia":
      ...
      break;
    case "Jamaica":
      currentCountyShippingPrice = `Shipping to ${country} will cost 120 credits`;
      break;
    default:
      currentCountyShippingPrice = `Sorry, there is no delivery to your country`;
      break;
  }
  return currentCountyShippingPrice;
}
